...
import FollowersListScreen from './components/main/profile/FollowersList';
...
// LogBox is not available on web, so we need to check
if (Platform.OS !== 'web') {
...
const firebaseConfig = {
  apiKey: "AIzaSyAwgwXGxJ4uN-Ax0GWRYyzrLw0PDH7u3SA",
  authDomain: "instagram-clone-9e0f9.firebaseapp.com",
  projectId: "instagram-clone-9e0f9",
  storageBucket: "instagram-clone-9e0f9.firebasestorage.app",
  messagingSenderId: "128026812376",
  appId: "1:128026812376:web:cdf6c31d689b7f29569cad",
  measurementId: "G-GTSLR2G57S"
};
...
// Initialize Auth with AsyncStorage persistence for SDK 54
let auth;
try {
